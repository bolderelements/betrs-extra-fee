 ...
 */
class BETRS_Extra_Fee_Upgrader {
    ...
    function __construct( $pluginFile, $gitHubUsername, $gitHubProjectName, $accessToken = '' ) {
        ...
        $this->slug_base = 'betrs-extra-fee';
    ...
    private function initGitData() {
        ...
        $raw_response = wp_remote_get( 'https://bolderelements.github.io/plugin-info/betrs-extra-fee.json' );
    ...
    private function getRepoReleaseInfo() {
        ...
        $url = "https://api.github.com/repos/bolderelements/betrs-extra-fee/releases";
